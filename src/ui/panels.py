...
class TextWatermarkPanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        opacity_row.addWidget(QLabel("透明度 (0-100)"))
        ...
        rotation_row.addWidget(QLabel("旋转(度)"))
        self.rotation_slider = QSlider(Qt.Horizontal)
        self.rotation_slider.setRange(-180, 180)
        self.rotation_slider.setValue(0)
        self.rotation_slider.valueChanged.connect(self.rotationChanged)
        self.rotation_value = QLabel("0°")
        self.rotation_slider.valueChanged.connect(lambda v: self.rotation_value.setText(f"{v}°"))
...
class ImageWatermarkPanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        img_opacity_row = QHBoxLayout()
        img_opacity_row.addWidget(QLabel("透明度(0-100)"))
        self.opacity_slider = QSlider(Qt.Horizontal)
        self.opacity_slider.setRange(0, 100)
        self.opacity_slider.setValue(50)
        self.img_opacity_value = QLabel("50")
        self.opacity_slider.valueChanged.connect(lambda v: self.img_opacity_value.setText(str(v)))
        img_opacity_row.addWidget(self.opacity_slider)
        img_opacity_row.addWidget(self.img_opacity_value)
        layout.addLayout(img_opacity_row)
        img_rotation_row = QHBoxLayout()
        img_rotation_row.addWidget(QLabel("旋转(度)"))
        self.rotation_slider = QSlider(Qt.Horizontal)
        self.rotation_slider.setRange(-180, 180)
        self.rotation_slider.setValue(0)
        self.img_rotation_value = QLabel("0°")
        self.rotation_slider.valueChanged.connect(lambda v: self.img_rotation_value.setText(f"{v}°"))
        img_rotation_row.addWidget(self.rotation_slider)
        img_rotation_row.addWidget(self.img_rotation_value)
        layout.addLayout(img_rotation_row)
...
class ExportPanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        jpeg_row.addWidget(QLabel("JPEG质量"))
        self.jpeg_quality = QSlider(Qt.Horizontal)
        self.jpeg_quality.setRange(1, 100)
        self.jpeg_quality.setValue(90)
        self.jpeg_quality_value = QLabel("90")
        self.jpeg_quality.valueChanged.connect(lambda v: self.jpeg_quality_value.setText(str(v)))
        jpeg_row.addWidget(self.jpeg_quality)
        jpeg_row.addWidget(self.jpeg_quality_value)
